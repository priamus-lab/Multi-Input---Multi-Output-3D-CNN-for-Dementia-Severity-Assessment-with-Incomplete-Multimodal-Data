...
enhance = 'false'
model_type = 'resnet34'
weightPath = basePath + 'MedicalNet_pytorch_files2/pretrain/resnet_34_23dataset.pth'
...
outputPath = basePath + 'MultimodalEARLY_MEDICAL_CN_MILD_SEVERE_' + normalizzazione_range_mri + '_P_' + normalizzazione_range_pet + '_'
...
Main_train(vali_set, test_set, patient_to_include, listClasses, newClasses, basePath_mri, basePath_pet, basePath_Paired, batch_size, outputPath,
